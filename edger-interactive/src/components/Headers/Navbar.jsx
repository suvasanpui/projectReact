...
const Navbar = () => {
  ...
  return (
    <div className="bg-white md:bg-[#1E7BC2] relative">
      <div className="flex justify-between items-center">
        {/* Logo and Company Name */}
        <div
          className="flex items-center px-6 md:px-12 bg-white relative"
          style={{
        ...
        <button
          ...
          className="md:hidden mr-4 text-[#1E7BC2]"
        >
          <Hamburger />
        </button>
      </div>
      ...
      {isMenuOpen ? (
        <div className="flex flex-col space-y-3 p-4">
          <a href="#" className="text-[#1E7BC2] hover:text-blue-600">
            Home
          </a>
          <a href="#" className="text-[#1E7BC2] hover:text-blue-600">
            About Us
